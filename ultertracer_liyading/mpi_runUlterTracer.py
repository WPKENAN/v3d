...
def ulterTracer(brainPath,markerPath,outPath,brainId,vaa3dPath,id):
    commandStr='sh /home/liyading/PBserver/wpkenan/10000/mutil_batch_auto_tracing-app2_liyading.sh \'{}\' \'{}\' \'{}\' \'{}\' {} {}'\
...
if __name__=="__main__":
    ...
    brainFolder='/home/liyading/PBserver/TeraconvertedBrain'
    brainFileDict={}
    for brainId in apoFileDict.keys():
    ...
    #
            ...
            #                                                    '/home/liyading/v3d_external/bin',\
            #                                                    brainId
            # print()
            ...
            pool.apply_async(ulterTracer,
                             (brainFileDict[brainId],
                              ...
                              os.path.join(resultFolder,brainId,'out'),
                              brainId,
                              '/home/liyading/dingl/vaa3d_gitcode/vaa3d_tools/bin',markerPath[0:6]))
